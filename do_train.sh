...
CMD="python2 -m src.main --d_lr 1e-4 --e_lr 1e-5 --log_img_step 1000 --pretrained_model_path=${PRETRAINED} --data_dir ${DATA_DIR} --e_loss_weight 60. --batch_size=64 --use_3d_label False --e_3d_weight 60. --datasets lsp,h36m --epoch 75 --log_dir logs"
